...
public class TaskController {
    ...
    public String viewTask(@PathVariable("id") Long id, Model model){
        Task task =  this.taskService.findById(id).orElseThrow(() -> new IllegalArgumentException(("Task not found" + id.toString())));
    ...
    public String editTask(@PathVariable("id") Long id, Model model) {
        Task task = this.taskService.findById(id)
                .orElseThrow(() -> new IllegalArgumentException("Task not found " + id.toString()));
